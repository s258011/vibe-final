...
def handle_my_custom_event(arg1):
    global frame_per_second, threshold, record_result, model2, label_model, avg_stack, avg_countr
    ...
    try:
        ...
        img = np.fromstring(base64.b64decode(img_string.split(',')[1]), np.uint8)
        # frame = np.array(pimg)
